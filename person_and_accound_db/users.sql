...
create table emails(id serial primary key, email varchar(100), users_id int references users(id)); --A table named emails was created, which has a column email and is linked to the users table through the users_id column.
